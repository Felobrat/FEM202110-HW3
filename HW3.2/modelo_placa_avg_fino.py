...
write_node_data("ux_avg_fino.msh", nodes, uv[:,0], "Despl. X" )
write_node_data("uy_avg_fino.msh", nodes, uv[:,1], "Despl. Y" )

write_node_data_2("desplazamientos_avg_fino.msh", nodes, uv[:,0], uv[:,1], "Despl" )
...
write_element_data("sigma_x_avg_fino.msh", elements, sigmaxx, "Sigma_x" )
write_element_data("sigma_y_avg_fino.msh", elements, sigmayy, "Sigma_y" )
write_element_data("sigma_xy_avg_fino.msh", elements, sigmaxy, "Sigma_xy" )