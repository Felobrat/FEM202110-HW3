...
for i in range(Nelements):
	...
	if element_type == QUAD_ELEMENT and \
		...
		Nquads += 1
		#DENTRO DE ESTE FOR EL CONEC SI TIENE LOS VALORES, PERO COMO QUE NO LOS GUARDA?
print(conec[15])
...
#Manuealmente agregar cargas

nodes = [7-1,102-1,103-1,104-1,105-1,106-1,107-1,108-1,8-1]
...
write_node_data_2("desplazamientos.msh", nodes, uv[:,0] , "Despl" ) #,uv[:,1]
